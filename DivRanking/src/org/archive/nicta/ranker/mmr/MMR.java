...
package org.archive.nicta.ranker.mmr;
...
public class MMR extends ResultRanker {
	...
	public double computeMMRScore(String doc_name, Set<String> S, Object query_sim, Object query_div) {
	...
	public ArrayList<String> getResultList(String query, int list_size) {
		...
		// Initialize the set of all sentences minus the selected sentences
