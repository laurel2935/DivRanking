...
public class NDEvalLosses extends Metric {
	...
	static{
		...
		//NRBP,nNRBP,MAP-IA
		//P-IA@5,P-IA@10,P-IA@20,Strec@5,Strec@10,Strec@20
		metricVector.add("ERR-IA@5");metricVector.add("ERR-IA@10");metricVector.add("ERR-IA@20\n");
		metricVector.add("nERR-IA@5");metricVector.add("nERR-IA@10");metricVector.add("nERR-IA@20\n");
		metricVector.add("alpha-DCG@5");metricVector.add("alpha-DCG@10");metricVector.add("alpha-DCG@20\n");
		metricVector.add("alpha-nDCG@5");metricVector.add("alpha-nDCG@10");metricVector.add("alpha-nDCG@20\n");
		metricVector.add("NRBP\n");metricVector.add("nNRBP\n");metricVector.add("MAP-IA\n");
		metricVector.add("P-IA@5");metricVector.add("P-IA@10");metricVector.add("P-IA@20\n");
	...
	*/
	public static String NDEVAL = ToolDirectory.ROOT+"trec_ndeval/ndeval10" + 
			(System.getProperty("os.name").toLowerCase().startsWith("windows") ? ".exe" : "");
	...
	public Object eval(TRECQueryAspects qa, List<String> docs) {
		...
		try {
			...
			int rank = 1;
			for (String doc : docs) {
				ndeval_tmp.println(qa._intNumber + " Q0 " + doc + " " + rank + " " + (100-rank) + " ANON_ALG");
				++rank;
			}
			ndeval_tmp.close();
	...
	public Object getMetricArray(){
		return metricVector.toArray(new String[0]);
	}
